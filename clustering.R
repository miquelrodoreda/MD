...
# REPEAT THE KMEANS RUN WITH K=5
k2 <- kmeans(dcon, 5)
k2$size
...
# Cut the dendrogram and display the classes
nc = 3
c1 <- cutree(h1, nc)
...
# Visualize categorical variables with boxplots
